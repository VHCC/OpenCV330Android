package acl.siot.opencvwpc20191007noc.api.getUser;
 ...
 */
public class GetUser extends HashMap<String, String> {
    ...
    public GetUser(String id) {
        ...
        super.put(APP_KEY_HTTPS_URL, URLConstants.SERVER_URL + "/api/user/info");
