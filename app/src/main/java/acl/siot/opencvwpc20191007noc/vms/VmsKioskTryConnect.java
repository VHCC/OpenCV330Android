...
/**
 * Created by IChen on 2021/05/03.
 */
public class VmsKioskTryConnect extends HashMap<Object, Object> {

    final String API_KEY_TRYCONNECTCODE = "tryConnectCode";

    public VmsKioskTryConnect(String vmsHost) {

        super.put(API_KEY_TRYCONNECTCODE, vmsHost);
        ...
        super.put(APP_KEY_HTTPS_URL, httpPrefix + VMSEdgeCache.getInstance().getVmsHost() + vmsPort + "/api/v2/vmsKioskDevice/tryToConnectVMS");
    }
