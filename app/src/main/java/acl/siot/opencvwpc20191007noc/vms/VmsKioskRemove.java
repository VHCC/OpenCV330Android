...
/**
 * Created by IChen on 2021/05/04.
 */
public class VmsKioskRemove extends HashMap<Object, Object> {

    final String API_KEY_UUID = "uuid";

    public VmsKioskRemove(String kioskUUID) {
        ...
        super.put(APP_KEY_HTTPS_URL, httpPrefix + VMSEdgeCache.getInstance().getVmsHost() + vmsPort +"/api/v2/vmsKioskDevice/removeDevice");
    }
