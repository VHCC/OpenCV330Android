 ...
 */
public class VmsKioskHB extends HashMap<Object, Object> {

    final String API_KEY_UUID = "uuid";

    public VmsKioskHB(String kioskUUID) {
        ...
        super.put(APP_KEY_HTTPS_URL, httpPrefix + VMSEdgeCache.getInstance().getVmsHost() + vmsPort + "/api/v2/vmsKioskDevice/deviceHeartBeats");
    }
